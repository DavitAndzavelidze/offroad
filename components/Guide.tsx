...
import { topToBottom, bottomToTop } from "@/utils/motion";
...
const Guide = () => {
  return (
    <section id="guide" className="flexCenter flex-col">
      ...
      >
        <Image src="/offroad.svg" alt="camp" width={50} height={50} />
      ...
      >
        ...
        <div className="absolute flex bg-white py-6 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          <Image
            src="/meter.svg"
            alt="meter"
            width={16}
